...
//#warning("TODO: Проверить работу тем на всех окнах") //done

//#warning("TODO: Проверить корректное сохранение всех настроек") //done

//#warning("TODO: Проверить корректность сохранения добавленной любви") //done
...
//#warning("TODO: Отформатировать и добавить красивостей в текст ^О программе^") //done

//#warning("TODO: Сделать отступы текста в ^О программе^") //done

//#warning("TODO: Куда-нибудь добавить версию программы, например в настройки") //done

#warning("TODO: Сделать пасхалку - миниигру по десятикратному тапу по иконке любви")

//#warning("TODO: Пофиксить смену цвета текста на navbar") //done

#warning("TODO: Рефакторить темы")

#warning("TODO: Финишный рефакторинг кода")
